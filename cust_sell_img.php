	...
	<div class="row">
		...
		<form method="post" name="form1" class="contact" enctype="multipart/form-data">
							<div class="form-group has-feedback">
								<label for="email">Image Id</label>
								<input type="text" class="form-control" name="txtiid"  value="<?php echo $iid; ?>" placeholder="" readonly="readonly">
							</div>
									...
									<?php
										...
										if(mysqli_num_rows($qur1)>0)
										{
											...
											while($q1=mysqli_fetch_array($qur1))
											{
												...
												echo "<td><a href='cust_sell_img.php?did=$q1[0]&pid=$pid' >DELETE</a></td>";
												echo "</tr>";
											}
											echo "</table>";
										}else{
